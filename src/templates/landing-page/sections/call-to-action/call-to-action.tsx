...
export function CallToAction() {
  return (
    <section className="relative py-24 bg-gradient-to-b from-cyan-950/20 to bg-gray-700">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 p-4 bg-cyan-300 w-fit rounded-full hover:bg-cyan-900">
        <Store className="text-cyan-100" />
      </div>

      <div className="container relative">
        <div className="flex flex-col items-center gap-6 text-center">
          <h2 className="font-sans text-gray-100 text-heading-lg text-balance">
