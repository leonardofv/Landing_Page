            ...
            <div className="p-2 rounded-md overflow-hidden">
                ...
                <div className="relative">
                    <div className="absolute top-0 right-0 px-3 py-1">
                        <span className="text-gray-300 text-body-xs">20/12/2024
                        </span>
                    </div>
                    <Image 
                        src={'/assets/post-01.png'}
                        alt=""
                        width={288}
                        height={144}
                ...
                <div className="border px-2 mt-4 space-y-4">
                    <h2 className="text-gray-100 text-heading-sm line-clamp-3">Transformando seu negócio em uma loja virtual</h2>
                    ...
                    <div className="flex flex-center gap-3 border-t border-gray-400 py-4">
                        ...
                        <span className="text-gray-300 text-body-sm">Leo</span>
                    </div>
                </div>
            </div>
        </Link>
